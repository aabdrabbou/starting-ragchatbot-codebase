...
"""
    ...
    def generate_response(
        ...
        while round_state.should_continue(max_rounds):
            ...
            try:
                ...
                if response.stop_reason == "tool_use" and tool_manager:
                    ...
                    round_state = self._execute_round_tools(
                        response, round_state, tool_manager, tools
                    )
                ...
                if round_state.round_number == 1:
                    ...
                    if (
                        hasattr(round_state.last_response, "content")
                        and round_state.last_response.content
                    ):
        ...
        try:
            ...
            if round_state.last_response and hasattr(
                round_state.last_response, "content"
            ):
                for content_block in round_state.last_response.content:
                    if hasattr(content_block, "text"):
                        return content_block.text
    ...
    def _execute_round_tools(
        self, response, round_state: RoundState, tool_manager, tools: list | None
    ) -> RoundState:
        """
