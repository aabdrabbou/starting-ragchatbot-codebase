...
class TestRAGSystem(unittest.TestCase):
    ...
    def test_query_with_content_specific_question(self):
        ...
        mock_sources = [
            {"text": "MCP: Build Rich-Context AI Apps - Lesson 1", "link": "https://example.com/mcp1"}
        ]
    ...
    def test_add_course_document_error(self):
        ...
        # Add course document
        course, chunk_count = self.rag_system.add_course_document("/path/to/bad_file.txt")
    ...
    def test_add_course_folder_success(self, mock_listdir, mock_exists):
        ...
        mock_chunks1 = [CourseChunk(content="Content 1", course_title="New Course 1", chunk_index=0)]
        mock_chunks2 = [CourseChunk(content="Content 2", course_title="New Course 2", chunk_index=0)]
        ...
        # Add course folder
        total_courses, total_chunks = self.rag_system.add_course_folder("/path/to/courses")
        ...
        self.assertEqual(self.mock_document_processor.process_course_document.call_count, 2)
    ...
    def test_add_course_folder_missing_path(self, mock_exists):
        ...
        total_courses, total_chunks = self.rag_system.add_course_folder("/path/to/missing")
    ...
    def test_add_course_folder_skip_existing(self, mock_listdir, mock_exists):
        ...
        self.mock_vector_store.get_existing_course_titles.return_value = [existing_title]
    ...
    def test_get_course_analytics(self):
        ...
        self.mock_vector_store.get_existing_course_titles.return_value = mock_course_titles
