...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_generate_response_with_tool_use(self, mock_anthropic_client):
        ...
        final_response = MockAnthropicResponse("Based on the course content, machine learning is...")
        
        # Configure mock client to return different responses
        mock_client.messages.create.side_effect = [initial_response, final_response]
        
        # Mock tool manager execution
        self.mock_tool_manager.execute_tool.return_value = "Machine learning content from course"
    ...
    def test_generate_response_multiple_tool_calls(self, mock_anthropic_client):
        ...
        initial_response = MockAnthropicResponse(
            stop_reason="tool_use",
            tool_calls=[tool_use_1, tool_use_2]
        )
    ...
    @patch('anthropic.Anthropic')
    def test_sequential_tool_calling_max_rounds_termination(self, mock_anthropic_client):
    ...
    def test_sequential_tool_calling_early_termination(self, mock_anthropic_client):
        ...
        self.assertEqual(result, "I have sufficient information to answer your question.")
