...
class TestVectorStoreIntegration(unittest.TestCase):
    ...
    def test_search_with_course_filter(self):
        ...
        course1_chunks = [
            CourseChunk(content="Python programming basics", course_title="Python Course", lesson_number=1, chunk_index=0),
            CourseChunk(content="Advanced Python concepts", course_title="Python Course", lesson_number=2, chunk_index=1)
        ]
        
        course2_chunks = [
            CourseChunk(content="JavaScript fundamentals", course_title="JavaScript Course", lesson_number=1, chunk_index=0),
            CourseChunk(content="React and modern JavaScript", course_title="JavaScript Course", lesson_number=2, chunk_index=1)
        ]
    ...
    def test_search_with_lesson_filter(self):
        ...
        test_chunks = [
            CourseChunk(content="Lesson 1 content about basics", course_title="Test Course", lesson_number=1, chunk_index=0),
            CourseChunk(content="Lesson 2 content about advanced topics", course_title="Test Course", lesson_number=2, chunk_index=1),
            CourseChunk(content="Lesson 3 content about expert level", course_title="Test Course", lesson_number=3, chunk_index=2)
        ]
    ...
    def test_search_no_results(self):
        ...
        # Add some content
        test_chunks = [
            CourseChunk(content="Python programming", course_title="Python Course", lesson_number=1, chunk_index=0)
        ]
        self.vector_store.add_course_content(test_chunks)
